...
export const makeWChar = R.identity;


// makeWCharId :: Int -> Int -> WCharId
export const makeWCharId = (clientId, clock) => {
...
export const wCharBeginning = makeWChar({
  id: wCharIdBeginning,
  isVisible: false,
  alpha: ' ',
...
// wCharEnding :: WCharId
export const wCharEnding = makeWChar({
  id: wCharIdEnding,
  isVisible: false,
  alpha: ' ',
  prevId: wCharIdBeginning,
...
// hide :: WChar -> WChar
export const hide = R.assoc('isVisible', false);


// compareCharIds :: WCharId -> WCharId -> Ordering (-1, 0, 1)
export const compareWCharIds = (idA, idB) => {
